const client = contentful.createClient({
    ...
    accessToken: "NWkj22CLZQL5dcnuLL7yleNU0OgN5izqM-zUFpjar4Q"
  });
  //variables
  ...
  class UI{
    ...
    getBagButtons(){
      ...
      //[...] creates an array out of a node list
      buttonsDOM = buttons;
      buttons.forEach(button =>{
        ...
        if(inCart){
          ...
          button.addEventListener("click",(event) =>{
            ...
            amount :1};
            //render another page
            localStorage.setItem("selected-id",cartItem);
            window.location = "../../views/product.ejs"
